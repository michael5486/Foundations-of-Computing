...
static const char *const yytname[] =
{
  ...
  "'/'", "'|'", "UMINUS", "';'", "'('", "')'", "','", "$accept", "stmt",
  "list", "exp", "explist", "symlist", "prog", 0
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 35 "parser_hw1.y"
    { (yyval.a) = newflow('I', (yyvsp[(2) - (4)].a), (yyvsp[(4) - (4)].a), NULL); }
    break;

  case 3:
#line 36 "parser_hw1.y"
    { (yyval.a) = newflow('I', (yyvsp[(2) - (6)].a), (yyvsp[(4) - (6)].a), (yyvsp[(6) - (6)].a)); }
    break;

  case 4:
#line 37 "parser_hw1.y"
    { (yyval.a) = newflow('W', (yyvsp[(2) - (4)].a), (yyvsp[(4) - (4)].a), NULL); }
    break;

  case 6:
#line 41 "parser_hw1.y"
    { (yyval.a) = NULL; }
    break;

  case 7:
#line 42 "parser_hw1.y"
    { if((yyvsp[(3) - (3)].a) == NULL) { (yyval.a) = (yyvsp[(1) - (3)].a); } else { (yyval.a) = newast('L', (yyvsp[(1) - (3)].a), (yyvsp[(3) - (3)].a)); } }
    break;

  case 8:
#line 45 "parser_hw1.y"
    { (yyval.a) = newcmp((yyvsp[(2) - (3)].fn), (yyvsp[(1) - (3)].a), (yyvsp[(3) - (3)].a)); }
    break;

  case 9:
#line 46 "parser_hw1.y"
    { (yyval.a) = newast('+', (yyvsp[(1) - (3)].a), (yyvsp[(3) - (3)].a)); }
    break;

  case 10:
#line 47 "parser_hw1.y"
    { (yyval.a) = newast('-', (yyvsp[(1) - (3)].a), (yyvsp[(3) - (3)].a)); }
    break;

  case 11:
#line 48 "parser_hw1.y"
    { (yyval.a) = newast('*', (yyvsp[(1) - (3)].a), (yyvsp[(3) - (3)].a)); }
    break;

  case 12:
#line 49 "parser_hw1.y"
    { (yyval.a) = newast('/', (yyvsp[(1) - (3)].a), (yyvsp[(3) - (3)].a)); }
    break;

  case 13:
#line 50 "parser_hw1.y"
    { (yyval.a) = newast('|', (yyvsp[(2) - (2)].a), NULL); }
    break;

  case 14:
#line 51 "parser_hw1.y"
    { (yyval.a) = (yyvsp[(2) - (3)].a); }
    break;

  case 15:
#line 52 "parser_hw1.y"
    { (yyval.a) = newast('M', (yyvsp[(2) - (2)].a), NULL); }
    break;

  case 16:
#line 53 "parser_hw1.y"
    { (yyval.a) = newnum((yyvsp[(1) - (1)].d)); }
    break;

  case 17:
#line 54 "parser_hw1.y"
    { (yyval.a) = newref((yyvsp[(1) - (1)].s)); }
    break;

  case 18:
#line 55 "parser_hw1.y"
    { (yyval.a) = newasgn((yyvsp[(1) - (3)].s), (yyvsp[(3) - (3)].a)); }
    break;

  case 19:
#line 56 "parser_hw1.y"
    { (yyval.a) = newfunc((yyvsp[(1) - (4)].fn), (yyvsp[(3) - (4)].a)); }
    break;

  case 20:
#line 57 "parser_hw1.y"
    { (yyval.a) = newcall((yyvsp[(1) - (4)].s), (yyvsp[(3) - (4)].a)); }
    break;

  case 22:
#line 61 "parser_hw1.y"
    { (yyval.a) = newast('L', (yyvsp[(1) - (3)].a), (yyvsp[(3) - (3)].a)); }
    break;

  case 23:
#line 64 "parser_hw1.y"
    { (yyval.sl) = newsymlist((yyvsp[(1) - (1)].s), NULL); }
    break;

  case 24:
#line 65 "parser_hw1.y"
    { (yyval.sl) = newsymlist((yyvsp[(1) - (3)].s), (yyvsp[(3) - (3)].sl)); }
    break;

  case 26:
#line 69 "parser_hw1.y"
    { eval((yyvsp[(2) - (3)].a)); treefree((yyvsp[(2) - (3)].a)); }
    break;

  case 27:
#line 70 "parser_hw1.y"
    { dodef((yyvsp[(3) - (9)].s), (yyvsp[(5) - (9)].sl), (yyvsp[(8) - (9)].a)); printf("Defined %s\n> ", (yyvsp[(3) - (9)].s)->name); }
    break;

  case 28:
#line 71 "parser_hw1.y"
    { yyerrok; printf("> "); }
    break;
